    ...
    def crawl_all_color_for_shoes(self,url):
        ...
        for i,style_id in enumerate(color_ids):
            ...
            for size in self.all_size:
                data_url = 'http://www.shihuo.cn/sports/getSuppliers?goods_id='+str(shoes_info.id)+'&size='+size+'&style_id='+style_id+'&color=&supplier_id=&price_sort=asc&tag=&page=1&page_size=1'
